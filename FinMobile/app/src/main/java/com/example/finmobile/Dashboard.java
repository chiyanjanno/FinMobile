...
import com.example.finmobile.other.CircleTransform;
...
public class Dashboard extends AppCompatActivity
   ...
   @Override
    ...
    private void loadImageByResource(){ int resourceId = R.drawable.logo;
        //the url
    }
